<?php require("partials/thehead.php")?>
    ...
    <form action = "admin-changepass.php" autocomplete="false" method = "POST" class = "my-4">
        <div class = "container-fluid d-flex flex-column" style = "background: #f8f8f8; width: 600px; border-radius: 5px"> 
            <div class = "row pt-5">
            ...
            <div class = "row">
                <div class = "col-10 mx-auto my-4 mb-2">
                    <button type="submit" class="btn submit-btn" style = "color: white; background: black;">Submit</button>
                </div>
            </div>
        </div>
    </form>
